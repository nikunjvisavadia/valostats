...
require '../config.php';
if(isset($_POST['dlt_team']))
{
  $team_id = $_POST['dlt_team'];
  
  $query = "DELETE FROM teams WHERE t_id ='$team_id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $t_name = $_POST["t_name"];
    $region = $_POST["region"];
    $rank_pts = $_POST["rank_pts"];
    $exists = false;
    $sql = "INSERT INTO `teams` (`t_id`, `t_name`, `region`, `rank_pts`) VALUES ('$t_id', '$t_name', '$region', '$rank_pts');";
...
>
  <div class="offcanvas-body p-0">
    ...
    <?php
      ...
      ?>
            <span class="fw-bold fs-3">Add New Team</span>
            <hr>
                ...
                <div class="row flex frm">
                    ...
                    <div class="col-md-2">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="rank_pts" required>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-3">
            ...
            <hr>
            <span class="fw-bold fs-3">Manage Teams</span>
            <hr>
            <div class="table-responsive ">
        <table id="teams" class="table table-hover table-borderless table-dark py-2" style="width: 100%">
          <thead>
            <tr>
              <th>Team ID</th>
              <th>Team Name</th>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <?php echo $res['rank_pts'];  ?>
                </td>
                <td>
                  <a href="team_edit.php?t_id=<?php echo $res['t_id']; ?>" class="btn btn-outline-success btn-sm">Edit</a>
                  <form method="POST" class="d-inline">
                  <button type="submit" value="<?php echo $res['t_id'];?>" class="btn btn-outline-danger btn-sm" name="dlt_team">Delete</button>
                  </form>
                </td>
              </tr>
              <?php
