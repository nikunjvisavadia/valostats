...
if(isset($_POST['a_update']))
{
    ...
    $query = "UPDATE agents SET a_id='$a_id', a_name='$a_name' WHERE a_id='$a_id'";
...
<body>
    ...
    <nav class="navbar navbar-dark navbar-expand-lg bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <a class="btn btn-outline-secondary ms-auto fw-bold" href="agents.php">Back</a>
        </div>
        </div>
    </nav>
    <!-- NavBar -->
    ...
    <main class="mt-5 pt-3">
        <div class="container-fluid">
            <span class="fw-bold fs-3">Update Agent</span>
            <hr>
            <?php
            if (isset($_GET['a_id'])) {
                $a_id = $_GET['a_id'];
                $query = "SELECT * FROM agents WHERE a_id = '$a_id' ";
                $query_run = mysqli_query($conn, $query);
                        ...
                        <div class="row flex frm">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $result['a_name'];?>" name="a_name">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-outline-dark" name="a_update">Update</button>
                                </div>
                            </div>
                        </div>
                    </form>
