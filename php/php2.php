...
<body>  
    ...
    <h3>PHP Cookies and session Example</h3>
    <?php
    $cookie_name = "user";
    $cookie_value = "Prince";
    ...
    <h3>browser control and detection</h3>
    <?php
        echo "<br><br>";
    ...
    <?php
        ...
        $file = fopen("webdictionary.txt", "a") or die("Unable to open file!");
        $txt = "i am 24\n";
        fwrite($file, $txt);
