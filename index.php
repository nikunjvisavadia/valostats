...
<body>
  ...
  <div class="crd card bg-dark">
    ...
    <div class="card-body">
      ...
      <a href="stats.php" class="btn btn-outline-danger change-photo" data-photo-url="./image/1086709.png" data-original-photo="./image/1081933.jpg">See More</a>
        ...
        <div class="col">
            <div class="crd card bg-dark">
                ...
                <div class="card-body">
                    ...
                    <a href="ranking.php" class="btn btn-outline-danger change-photo" data-photo-url="./image/kj.jpg" data-original-photo="./image/neon.jpg">See More</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class=" crd card bg-dark">
                ...
                <div class="card-body">
                    ...
                    <!-- <a href="stats.php" class="btn btn-outline-danger">See More</a> -->
                    <a href="stats.php" class="btn btn-outline-danger change-photo" data-photo-url="./image/phinix.jpg" data-original-photo="./image/1149777.jpg">See More</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="crd card bg-dark">
                <img src="./image/1098683.png" class="card-img-top card-image" alt="..." data-original-url="./image/1098683.png">
                <div class="card-body">
                    <h5 class="card-title">Consistency is the Key..!</h5>
                    <p class="card-text">Find out the most consistant player in the game...!</p>
                    <!-- <a href="stats.php" class="btn btn-outline-danger">See More</a> -->
                    <a href="stats.php" class="btn btn-outline-danger change-photo" data-photo-url="./image/raze.png" data-original-photo="./image/1098683.png">See More</a>
                </div>
            </div>
        </div>
    </div>
